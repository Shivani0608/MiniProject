...
<head>
    ...
    &lt;%&ndash;https://code.jquery.com/jquery-3.3.1.js&ndash;%&gt;


    <!-- JQuery -->
    &lt;%&ndash;<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>&ndash;%&gt;
    <!-- Bootstrap tooltips -->
    ...
    &lt;%&ndash;<script src="http://code.jquery.com/jquery-latest.js"></script>&ndash;%&gt;
...
<div class="w3-content container-fluid" style="max-width:2000px;margin-top:70px">
    ...
    <div class="mySlides w3-display-container w3-center">
        ...
        <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
            <h3>&lt;%&ndash;Los Angeles&ndash;%&gt;</h3>
            <p><b>&lt;%&ndash;We had the best time playing at Venice Beach!&ndash;%&gt;</b></p>
        </div>
    </div>
    <div class="mySlides w3-display-container w3-center">
        <img src="img/pic5.JPG" style="width:100%;height: 450px;margin-right:80px;">
        <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
            <h3>&lt;%&ndash;Chicago&ndash;%&gt;</h3>
            <p><b>&lt;%&ndash;Thank you, Chicago - A night we won't forget.&ndash;%&gt;</b></p>
        </div>
    </div>
    <div class="mySlides w3-display-container w3-center">
        <img src="img/pic4.jpeg" style="width:100%;height: 450px;margin-right:80px;">
        <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
            <h3>&lt;%&ndash;New York&ndash;%&gt;</h3>
            <p><b>&lt;%&ndash;The atmosphere in New York is lorem ipsum.&ndash;%&gt;</b></p>
        </div>
    </div>
    <div class="mySlides w3-display-container w3-center">
